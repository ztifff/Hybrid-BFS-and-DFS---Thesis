...
- Name: stc-ui.spec.ts >> Simple Test Cases UI (STC-06 to STC-15) >> STC-21: System (Negative Node Sizing)
- Location: tests\stc-ui.spec.ts:192:3
...
Call log:
  - waiting for getByRole('button', { name: /SM City/i })
