...
- Name: etc.spec.ts >> Edge Test Cases (ETC-01 to ETC-15) >> ETC-12: Robotics (Zero Robot Assignment/Fallback)
- Location: tests\etc.spec.ts:43:3
...
- complementary:
  ...
  - text: "[0] 💥 🔌 Cable Unplugged at Aggr-SW6 Dynamic Size Adjuster Nodes"
  - spinbutton "Nodes": "28"
  - button:
    - img
  - button:
